...
class CameraScreenState extends State<CameraScreen> {
    ...
    Future<void> updateProcessors() async {
      ...
      final cameraProcessorsLocal = List<ModelCameraProcessor<Object>>.from(_cameraProcessors);
      ...
      if (_yoloAvailable && _yoloEnabled) {
        cameraProcessorsLocal.add(ModelCameraProcessor<YOLOResult>(
            _resultStreamObjectDetect, YOLOFrameProcessor<YOLOv6SegConfig>(
    ...
    Widget build(BuildContext context) {
        return Scaffold(
            appBar: AppBar(
                ...
                actions: (
                    <Widget>[PopupMenuButton<ResolutionPreset>(
                      ...
                      itemBuilder: (BuildContext context) =>  <PopupMenuEntry<ResolutionPreset>>[
            ...
            Column(
                ...
                children: <Widget>[
                      ...
                      children: [
                        ...
                        AspectRatio(
                          ...
                          (_clipAvailable && _clipEnabled
                            ...
                            AspectRatio(
                                aspectRatio: 2 / 2,
                                child: MobileClipOverlay(_resultStreamClassify
                                    .stream))
                          ]
                              : [])
                  ),
                  ...
                  (_yoloAvailable && _yoloEnabled ? <Widget>[StreamTimingsWidget(_resultStreamObjectDetect.stream)] : []) +
                  (_clipAvailable && _clipEnabled ? <Widget>[StreamTimingsWidget(_resultStreamClassify.stream)] : [])
